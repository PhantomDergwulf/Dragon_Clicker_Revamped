AddLanguage('EN','english',{
	...
	"Fancy graphics": "/",
	"CSS filters": "/",
	"visual improvements; disabling may improve performance. Dragons may look slightly uglier as a result.": "/",
	"Particles": "/",
	"Numbers": "/",
	"numbers that pop up when clicking the dragon": "/",
	"Milk [setting]": "Milk",
	...
	"Alt font": "/",
	"your dragon are displayed using a monospace font": "/",
	"Short numbers": "/",
	"Fast notes": "/",
	...
	"Lump confirmation": "/",
	"the game will ask you to confirm before spending sugar snack": "/",
	"Scary stuff": "/",
	"Sleep mode timeout": "/",
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline DpS production kicks in during sleep mode": "/",
	"Music in background": "/",
	...
	"angered": "/",
	"Dragons in bank:": "/",
	"Dragons baked (this ascension):": "/",
	"Dragons baked (all time):": "/",
	"Dragons forfeited by ascending:": "/",
	"Legacy started:": "/",
	"with %1 ascension": 
	["Hand-made",
		"with %1 ascension",
	...
	"Seasonal event:": "/",
	"Research:": "/",
	"Furless Dragon Invasion status:": "/",
	"Pledge:": "/",
	"Furless Dragons popped:": "/",
	"Sugar snacks harvested:": "/",
	"Reindeer found:": "/",
	"Santa stages unlocked:": "/",
	"Dragon training:": "/",
	"Prestige": "/",
	"at %1% of its potential <b>(+%2% DpS)</b>": "/",
	...
	"%1 is over.": "/",
	"%1's bakery": "/",
	"Name your Dragon Temple": "/",
	"What should your Dragon Temple's name be?": "/",
	...
	"%1, age %2": "/",
	"Sugar snack!": "/",
	"Because you've worshiped a <b>billion dragons</b> in total, you are now attracting <b>sugar snacks</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may use them to make your dragons hyperactive!": "/",
	"A <b>sugar snack</b> is coalescing here, attracted by your accomplishments.": "/",
	"Your sugar snacks mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.": "/",
	"&bull; Sugar snack can be harvested when mature, though if left alone beyond that point they will start ripening (increasing the chance of harvesting them) and will eventually fall and be auto-harvested after some time.<br>&bull; Sugar snacks are delicious and may be used as currency for all sorts of things.<br>&bull; Once a sugar snack is harvested, another one will start growing in its place.<br>&bull; Note that sugar snacks keep growing when the game is closed.": "/",
	"This sugar snack has been exposed to time travel shenanigans and will take an excruciating <b>%1</b> to reach maturity.": "/",
	"This sugar snack is still growing and will take <b>%1</b> to reach maturity.": "/",
	"This sugar snack is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.": "/",
	"<b>This sugar snack is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.": "/",
	"This sugar snack grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two snacks.": "/",
	"This sugar snack grew to be <b>golden</b>; harvesting it will yield 2 to 7 snacks, your current dragons will be doubled (capped to a gain of 24 hours of your DpS), and you will find 10% more golden cookies for the next 24 hours.": "/",
	"This sugar snack was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 snacks.": "/",
	"This sugar snack is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 snacks and will refill your sugar snack cooldowns.": "/",
	"You harvested <b>%1</b> while you were away.": "/",
	"Sugar hyperactive activated!": "/",
	"Your dragons have been doubled.<br>+10% golden dragons for the next 24 hours.": "/",
	"Sugar snack cooldowns cleared!": "/",
	"Botched harvest!": "/",
	...
	"<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% DpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.": "/",
	"Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% DpS.": "/",
	"+%1!": "/",
	"You found %1!": "/",
	"Found <b>%1</b>!": "/",
	"You also found <b>%1</b>!": "/",
	"Lost %1!": "/",
	"Sweet!<br><small>Found 1 sugar snack!</small>": "/",
	"Lucky!": "/",
	"Ruin!": "/",
	"Dragon chain over. You made %1.": "/",
	"Dragon chain": "/",
	"Dragon chain broken.<br><small>You made %1.</small>": "/",
	"Dragon blab": [
	...
	"Exploded a furless dragon": "/",
	"Exploded a shiny furless dragon": "/",
	"Swallowed:": "/",
	"Reindeer names": [
		"Dasher",
		"Dancer",
	...
	"Krumblor, dragon hatchling": "/",
	"Krumblor, an actual dragon": "/",
	"Train %1": "/",
	"Aura: %1": "/",
	"Chip it": "/",
	"Hatch it": "/",
	...
	"The cost of switching your aura is <b>%1</b>.<br>This will affect your DpS!": "/",
	"Your dragon dropped something!": "/",
	"Breath of FIRE": "/", // The original was: "Breath of milk." Sorry, if I sound a bit odd; but should we even.. make dragons vomit.. milk..? Eugh... 
	"Dragon Cursor": "/",
	"Elder Battalion": "/",
	"Reaper of Fields": "/",
	"Earth Shatterer": "/",
	...
	"Ticker (angry grandma)": [
		...
		"I can smell your rotten dragons."
	],
	...
	"Ticker (grandma invasion start)": [
		"millions of bakers reported missing!", // The original mod had "Grandma" replaced with "Baker"
		"families around the continent report agitated, transfixed bakers!",
		"nurses report \"strange scent of dragons\" around human patients!"
	],
	"Ticker (grandma invasion rise)": [
		"town in disarray as strange bakers break into homes to kissing boys and yoinking utensils!",
		"whole continent undergoing mass exodus of angry bakers!",
	...
	"Ticker (misc)": [
		...
		"doctors advise against new dragon-free fad diet.",
		...
		"\"alright, I'll say it - I've never eaten a single dragon in my life\", reveals celebrity.",
	...
	"Your first batch goes right outside the sidewalk. The neighborhood reeks of dragon stink.": "/", // I don't think dragons on the first batch want to go in the trash, or be touched by a raccoon.
	"Your family accepts to try praising of your dragons.": "/",
	"Your dragons are popular in the neighborhood.": "/",
	"People are starting to talk about your dragons.": "/",
	"Your dragons are talked about for miles around.": "/",
	"Your dragons are renowned in the whole town!": "/",
	"Your dragons bring all the boys to the yard.": "/",
	"Your dragons now have their own website!": "/",
	"Your dragons are worth a lot of money.": "/",
	"Your dragons priase very well in distant countries.": "/",
	"People come from very far away to get a praise of your dragons.": "/",
	"Kings and queens from all over the world are enjoying your dragons.": "/",
	"There are now museums dedicated to your dragons.": "/",
	"A national day has been created in honor of your dragons.": "/",
	"Your dragons have been named a part of the world wonders.": "/",
	"History books now include a whole chapter about your dragons.": "/",
	"Your dragons have been placed under government surveillance.": "/",
	"The whole planet is enjoying praising your dragons!": "/",
	"Strange creatures from neighboring planets wish to try praising your dragons.": "/",
	"Elder gods from the whole cosmos have awoken to praise your dragons.": "/",
	"Beings from other dimensions lapse into existence just to get a praise of your dragons.": "/",
	"Your dragons have achieved sentience.": "/",
	"The universe has now turned into dragon, to the molecular level.": "/",
	"Your dragons are rewriting the fundamental laws of the universe.": "/",
	"A local news station runs a 10-minute segment about your dragons. Success!<br><small>(you win a dragon)</small>": "/",
	"it's time to stop playing, go touch grass, stinkmy": "/", // ...or take a shower.
	"Today is your lucky day!": "/",
	"Your lucky numbers are:": "/",
	"Fortune!": "/",
	"A golden dragon has appeared.": "/",
	"You gain <b>one hour</b> of your DpS (capped at double your bank).": "/",
	"You've unlocked a new upgrade.": "/",
	"Wish granted. Golden dragon spawned.": "/",
	"help me!": "/",
	"Ascend": "/",
	"You've been on this run for <b>%1</b>.": "/",
	"Your prestige level is currently <b>%1</b>.<br>(DpS +%2%)": "/",
	"Ascending now would grant you no prestige.": "/",
	"Ascending now would grant you<br><b>1 prestige level</b> (+1% DpS)<br>and <b>1 heavenly chip</b> to spend.": "/",
	"Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% DpS)<br>and <b>%3 heavenly chips</b> to spend.": "/",
	"You need <b>%1 more cookies</b> for the next level.": "/",
	"Do you REALLY want to ascend?<div class=\"line\"></div>You will lose your progress and start over from scratch.<div class=\"line\"></div>All your dragons will be converted into prestige and heavenly chips.": "/",
	"You will keep your achievements.": "/",
	"You will keep your achievements, building levels and sugar snacks.": "/",
	"Ascending": "/",
	"So long, dragons...": "/",
	"You forfeit your %1.": "/",
	"Prestige level:": "/",
	...
	"Each prestige level grants you a permanent <b>+%1% DpS</b>.<br>The more levels you have, the more dragons they require.": "/",
	...
	"This run will behave as if you'd just started the game from scratch. Prestige levels and heavenly upgrades will have no effect, as will sugar snack and building levels. Perma-upgrades and minigames will be unavailable.<div class=\"line\"></div>Some achievements are only available in this mode.": "/",
	"Your bingo center/research facility is conducting experiments.": "/",
	"Research has begun": "/",
	"Research complete": "/",
	"You have discovered: <b>%1</b>.": "/",
	"Valentine's Day!": "/",
	"It's <b>Valentine's season</b>!<br>Love's in the air and dragons are just that much cleaner!": "/",
	"Business Day!": "/",
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.": "/",
	"Halloween!": "/",
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier! oooOOOOoooo~": "/",
	"Christmas time!": "/",
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get a dragon in your home!": "/",
	"Easter!": "/",
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!": "/",
	"[Tag]Heavenly": "Heavenly",
	"[Tag]Tech": "Tech",
	"[Tag]Cookie": "Cookie", // I'm unsure of what [Tag] does. Leave it be until we find the use for it in the game.
	"[Tag]Debug": "Debug",
	"[Tag]Switch": "Switch",
	"[Tag]Upgrade": "Upgrade",
	"Tier:": "/",
	...
	"all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total DpS)": "/",
	"owned: %1": "/",
	"free: %1!": "/",
	"Level %1 %2": "/",
	"Granting <b>+%1% %2 DpS</b>.": "/",
	...
	"Grandmas gain <b>+%1% DpS</b> for each non-grandma building.": "/",
	"You gain <b>more DpS</b> the more milk you have.": "/",
	...
	"Clicking gains <b>+%1% of your DpS</b>.": "/",
	"%1 gain <b>+%2%</b> DpS per %3.": "/",
	...
	"Each %1 gains <b>+%2 base DpS per %3</b>.": "/",
	...
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your DpS.": "/",
	"You will get %1% of your DpS back, but the grandmatriarchs will return.": "/",
	...
	"<b>+%1% DpS</b> per golden cookie on-screen, multiplicative.": "/",
	...
	"Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed DpS and increases with every season switch.": "/",
	...
	"You continually gain <b>more DpS the longer you've played</b> in the current ascension.": "/",
	...
	"You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular DpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your DpS.)": "/",
	"You gain another <b>+%1%</b> of your regular DpS while the game is closed.": "/",
	"You gain another <b>+%1%</b> of your regular DpS while the game is closed, for a total of <b>%2%</b>.": "/",
	...
	"Unlocks the <b>golden switch</b>, which passively boosts your DpS by %1% but disables golden cookies.": "/",
	"Turning this on will give you a passive <b>+%1% DpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.": "/",
	...
	"While the golden switch is on, you gain an additional <b>+%1% DpS</b> per golden cookie upgrade owned.": "/",
	...
	"Sugar snack coalesce <b>a whole lot faster</b>.": "/",
	"<b>+%1%</b> prestige level effect on DpS.": "/",
	"<b>+%1%</b> prestige level effect on DpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.": "/",
	"Each unspent sugar snack (up to %1) gives <b>+%2% DpS</b>.<div class=\"warning\">Note: this means that spending sugar snacks will decrease your DpS until they grow back.</div>": "/",
	"Once an ascension, you may use the \"Sugar frenzy\" switch to <b>triple your DpS</b> for 1 hour, at the cost of <b>1 sugar snack</b>.": "/",
	"Each grandma (up to %1) makes sugar snacks ripen <b>%2</b> sooner.": "/",
	"Activating this will <b>triple your DpS</b> for 1 hour, at the cost of <b>1 sugar snack</b>.": "/",
	...
	"Sugar snacks are <b>twice as likely</b> to be unusual.": "/",
	"<b>+%1%</b> sugar snack growth.": "/",
	"Sugar snacks ripen <b>%1</b> sooner.": "/",
	"Sugar snacks mature <b>%1</b> sooner.": "/",
	"Bifurcated sugar snacks appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 snacks.": "/",
	"Mouse over a furless dragon to see how many cookies are in its stomach.": "/",
	...
	"Unlocks the <b>shimmering veil</b>, a switch that passively boosts your DpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of DpS to turn back on.": "/",
	"Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed DpS.": "/",
	"Has a <b>%1%</b> chance to not break.": "/",
	"The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more DpS.": "/",
	"Active.": "/",
	...
	"Cost scales with DpS, but %1 times cheaper with a fully-trained dragon.": "/",
	...
	"Each kitten upgrade boosts %1 DpS by <b>%2%</b>.": "/",
	"Each rank of milk boosts %1 DpS by <b>%2%</b>.": "/",
	...
	"DpS bonus fluctuating between %1 and %2 over time.": "/",
	...
	"Harvest <b>%1 coalescing sugar snack</b>.": "/",
	"Successfully harvest a coalescing sugar snack before it's ripe.": "/",
	"Harvest a <b>bifurcated sugar snack</b>.": "/",
	"Harvest a <b>golden sugar snack</b>.": "/",
	"Harvest a <b>meaty sugar snack</b>.": "/",
	"Harvest a <b>caramelized sugar snack</b>.": "/",
	"Reach level <b>%1</b> %2.": "/",
	"Cast <b>%1</b> spells.": "/",
	...
	"Convert a complete seed log into sugar snack by sacrificing your garden to the sugar hornets.<div class=\"line\"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.": "/",
	...
	"Effect is inactive.": "/",
	"Current bonus:": "/",
	"Garden": "/", // Below the lines are mini-game lines. This'll be pain to rework those. Like, honestly. =w=" -Carl
	"Baker's wheat": "/",
	...
	"Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar snacks</b>.</small>": "/",
	"Sacrifice!": "/",
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar snack</b>.": "/",
	"immortal": "/",
	"predictable growth": "/",
	...
	"harvest when mature for +%1 of DpS (max. %2% of bank)": "/",
	"harvest when mature for a sugar snack": "/",
	"useless": "/",
	"spreads easily": "/",
	"may spread as %1": "/",
	...
	"explodes into up to %1 of DpS at the end of its lifecycle (max. %2% of bank)": "/",
	...
	"Conjure Baked Goods": "/",
	"Summon half an hour worth of your DpS, capped at %1% of your cookies owned.": "/",
	"Trigger a %1-minute clot and lose %1 minutes of DpS.": "/",
	...
	"Buying a broker costs %1 of DpS (that's $%2).": "/",
	...
	"By taking this loan, you will get %1 DpS for the next %2.": "/",
	"However, you will get %1 DpS for the next %2 after that.": "/",
	...
	"[Upgrade name 867]Snowball Dragons": "Snowball cookies",
	...
	"[Achievement name 14]Dragon all the way down": "Cookies all the way down",
	...
	"[Achievement name 19]Dragon monster": "Cookie monster",
	"[Achievement name 20]Mass producer": "Mass producer",
	"[Achievement name 21]Dragon vortex": "Cookie vortex",
	"[Achievement name 22]Dragon pulsar": "Cookie pulsar",
	"[Achievement name 23]Dragon quasar": "Cookie quasar",
	...
	"[Achievement name 40]Grandma's Dragons": "Grandma's Dragons",
	...
	"[Achievement name 67]Golden dragon": "Golden dragon",
	"[Achievement name 68]Lucky dragon": "Lucky dragon",
	"[Achievement name 69]A stroke of luck": "A stroke of luck",
	"[Achievement name 70]Cheated dragons taste awful": "Cheated dragons taste awful",
	...
	"[Achievement name 240]Inevitably long achievement names are mildly infuriating, but since we also want to take it a step further. <br>A dragon is a large magical legendary creature that appears in the folklore of multiple cultures worldwide. Beliefs about dragons vary considerably through regions, but dragons in western cultures since the High Middle Ages have often been depicted as winged, horned, and capable of breathing fire. Dragons in eastern cultures are usually depicted as wingless, quadrupedal, serpentine creatures with above-average intelligence. Commonalities between dragons' traits are often a hybridization of feline, reptilian, mammal, and avian features.</br> Anyways, how you've been?": "Inevitably long achievement names are mildly infuriating, but since we also want to take it a step further. <br>A dragon is a large magical legendary creature that appears in the folklore of multiple cultures worldwide. Beliefs about dragons vary considerably through regions, but dragons in western cultures since the High Middle Ages have often been depicted as winged, horned, and capable of breathing fire. Dragons in eastern cultures are usually depicted as wingless, quadrupedal, serpentine creatures with above-average intelligence. Commonalities between dragons' traits are often a hybridization of feline, reptilian, mammal, and avian features.</br> Anyways, how you've been?",
	...
	"[Achievement name 259]dragon clicker forever and forever a hundred years dragon clicker, all day long forever, forever a hundred times, over and over dragon clicker adventures dot com": "dragon clicker forever and forever a hundred years dragone clicker, all day long forever, forever a hundred times, over and over dragon clicker adventures dot com",
	...
	"[Achievement name 397]When the dragons ascend just right": "When the dragons ascend just right",
	...
	"[Achievement name 506]Flip a dragon. Chips, I win. Crust, you lose.": "Flip a dragon. Chips, I win. Crust, you lose.",
	...
	"[Achievement name 591]Speed's the name of the game (no it's not it's called Dragon Clicker)": "Speed's the name of the game (no it's not it's called Dragon Clicker)",
	...
	"[Achievement name 595]Wrath dragon": "Wrath dragon",
	...
	"[Achievement name 639]Dragon Clicker": "Dragon Clicker",
